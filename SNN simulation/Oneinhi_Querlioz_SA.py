...
num_sample = int(sys.argv[4]) # the number of samples in the subset of the training dataset
...
#print('Number of the excitatory neuron: ' + str(population_OUT))
#print('test mode: ' + str(test_mode))
#print('number of examples for test or training: ' + str(num_example))
np.random.seed(0)
##-----------------------------------------------------------------------------------------
## file system
##-----------------------------------------------------------------------------------------
...
if using_test_dataset:
    ...
    if num_sample == 0:
        ...
        name_input_spike_record = 'mnist_spike_record_train' + '_' + str(num_example) + '_' + str(num_sample)
##-----------------------------------------------------------------------------------------
